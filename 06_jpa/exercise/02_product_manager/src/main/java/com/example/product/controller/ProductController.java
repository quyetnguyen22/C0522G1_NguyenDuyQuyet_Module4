...
public class ProductController {
    ...
    @GetMapping("/save")
    public String saveAddProduct(@ModelAttribute Product product,
    ...
    public ModelAndView searchProduct(@RequestParam String input) {
        List<Product> products = productService.searchProduct(input);
